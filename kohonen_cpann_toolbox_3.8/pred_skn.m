...
% prediction of unknown samples with Supervised Kohonen Networks (SKNs)
% pred_skn predicts classes of unknown samples by using a previuos model
% built by means of SKNs (model_skn)
% 
% pred = pred_skn(X,model);
%
% input:
%   X           data [n x p], n samples, p variables
%   model       model structure built with model_skn
% 
% output:
